...
import com.voting.domain.port.JpaVoteRepository;
...
public class VoteRepositoryAdapter implements VoteRepository {
    ...
    public List<Vote> findAll() {
        return jpaVoteRepository.findAll();
    }
    
    @Override
    public List<Vote> findActiveVotes() {
        return jpaVoteRepository.findActiveVotes();
    }
    
    @Override
    public List<Vote> findByCreatorId(Long creatorId) {
        return jpaVoteRepository.findByCreatorId(creatorId);
    }
	...
	@Override
	public <S extends Vote> S saveAndFlush(S entity) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public <S extends Vote> List<S> saveAllAndFlush(Iterable<S> entities) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public void deleteAllInBatch(Iterable<Vote> entities) {
		// TODO Auto-generated method stub
	...
	@Override
	public Vote getReferenceById(Long id) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public List<Vote> findAllById(Iterable<Long> ids) {
		// TODO Auto-generated method stub
		return null;
	}
